  ...
  return (
    <>
      <View style={{flex: 1,justifyContent: 'flex-start',padding: 30,marginTop: 20}}>
        ...
        <TextInput keyboardType='numeric' maxLength={12} placeholder="Enter your bill" style={{ width: '100%', height: 62, color: '#0a94a3', borderRadius: 10, padding: 5, margin: 20, backgroundColor: '#8cedf6', fontSize: 22, alignSelf: 'center' }} value={bill} onChangeText={newText => onChangeHandle(newText)} />
        <Text style={{ alignSelf: 'flex-start', fontSize: 22, color: '#0a94a3', fontWeight: 'bold' }}>Select tip %</Text>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
          ...
          <TextInput keyboardType='numeric' maxLength={2} placeholder="Custom" style={{ width: 130, height: 50, color: '#0a94a3', borderRadius: 10, backgroundColor: '#8cedf6', fontSize: 20, padding: 5 }} value={tipPercent} onChangeText={newTextt => handleChange(newTextt)} />
        </View>
        <Text style={{ alignSelf: 'flex-start', fontSize: 22, color: '#0a94a3', fontWeight: 'bold', marginVertical: 15 }}>Split/person</Text>
        <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
