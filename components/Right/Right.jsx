...
const Right = (props) => {
    ...
    return (
        <>
            <View style={{ backgroundColor: '#0a94a3', borderRadius: 10, flex: 2, marginTop: 20, padding: 10 }}>
                ...
                <TouchableOpacity onPress={props.handleReset}>
                    <View>
                        <Text style={{ marginTop:25,borderRadius: 10, paddingVertical: 10, paddingHorizontal: 10, backgroundColor: '#8cedf6', color: '#0a94a3', width: 280, height: 50, textAlign: 'center', fontSize: 22, fontWeight: 'bold' }}>Reset</Text>
                    </View>
                </TouchableOpacity>
            </View>
        </>
